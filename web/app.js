...
async function handleAdmin(req, res, url, sess) {
  ...
  if (p === '/flags' && req.method === 'POST') {   // [R11-P3] 后台一键开关
    ...
    const nw = b.toggle ? Object.assign({}, cur, { [b.toggle]: !cur[b.toggle] })
      : Object.assign({}, cur, { public_rest: b.public_rest === undefined ? cur.public_rest : !!b.public_rest, web_search_api: b.web_search_api === undefined ? cur.web_search_api : !!b.web_search_api, ui_gate: b.ui_gate === undefined ? cur.ui_gate : !!b.ui_gate },
